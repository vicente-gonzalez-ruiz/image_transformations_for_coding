...
\iframe{1200}{https://nbviewer.jupyter.org/github/vicente-gonzalez-ruiz/image_transformations_for_coding/blob/master/color_redundancy.ipynb}
\end{document}
\subsubsection{Chrominance subsampling}\label{chrominance-subsampling}}
...
means than the chroma can be subsampled without a signiﬁcant loss of
quality in the images.

    

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{c+c1}{\PYZsh{} pip install PyWavelets}
...
\end{itemize}
    ...
    \hypertarget{orthonormal-transform}{%
...
2300 coefficients
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_62_45.png}
    \end{center}
    { \hspace*{\fill} \\}
...
2500 coefficients
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_62_49.png}
    \end{center}
    { \hspace*{\fill} \\}
...
2700 coefficients
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_62_53.png}
    \end{center}
    { \hspace*{\fill} \\}
...
2900 coefficients
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_62_57.png}
    \end{center}
    { \hspace*{\fill} \\}
...
3100 coefficients
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_62_61.png}
    \end{center}
    { \hspace*{\fill} \\}
